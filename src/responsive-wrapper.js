...
export default function ResponsiveWrapper( {
	...
	const dialogProps = {
		className: 'wp-block-cdc-mobile-menu-template-part__responsive-dialog',
		...( isOpen && {
			role: 'dialog',
			'aria-modal': true,
			'aria-label': __( 'Menu' ),
	...
	return (
		<>
			...
			>
				<div
					className="wp-block-cdc-mobile-menu-template-part__responsive-close"
					tabIndex="-1"
				>
					<div { ...dialogProps }>
						<Button
							__next40pxDefaultSize
							className="wp-block-cdc-mobile-menu-template-part__responsive-container-close"
						...
						<div
							className="wp-block-cdc-mobile-menu-template-part__responsive-container-content"
							id={ `${ modalId }-content` }
						>
							{ children }
						</div>
